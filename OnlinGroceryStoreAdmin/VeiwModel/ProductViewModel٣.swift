...
////
////  Created by Mohamed Selim on 20/05/2025.
////
//
//
//import SwiftUI
...
//                                     
//                                     "nutrition_weight": txtNutritionWeight,
//                                     "price": txtPrice  ], path: Globs.Endpoints.SV_PRODUCT_UPDATE, isToken: true) {
//            responseObj in
//            
//            if let responseObj = responseObj as? NSDictionary {
//                if (responseObj.value(forKey: ResponseKeys.status) as? String ?? "" == "1"){
...
//                if (responseObj.value(forKey: ResponseKeys.status) as? String ?? "" == "1"){
//                            
//                    var payload = responseObj.value(forKey: ResponseKeys.payload) as? NSDictionary ?? [:]
